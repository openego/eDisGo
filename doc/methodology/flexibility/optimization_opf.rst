...
.. note::
   ...
   detail in the master's thesis it is based on:
      ...
      Institut), 2023.
      `PDF <https://reiner-lemoine-institut.de/publikation/masterarbeit-netzdienlich-optimaler-einsatz-von-flexibilitaeten-in-radialen-verteilnetzen-basierend-auf-einem-ac-lastflussmodell-held-2023/>`__
