...
class TestPypsaIO:
    ...
    def test_append_lv_components(self):
        ...
        append_lv_components('Generator', gens, lv_components, 'TestGrid',
        ...
        lv_components['Generator'] = pd.DataFrame()
        append_lv_components('Generator', gens.loc[gens.type == 'solar'],
        ...
        lv_components['Generator'] = pd.DataFrame()
        append_lv_components('Generator', gens.loc[gens.type == 'gas'],
                             lv_components, 'TestGrid',
                             aggregate_generators='curtailable')
        assert len(lv_components['Generator']) == 1
        assert lv_components['Generator'].index.values == \
        ...
        append_lv_components('Load', loads, lv_components, 'TestGrid',
        ...
        lv_components['Load'] = pd.DataFrame()
        append_lv_components('Load', loads.loc[loads.sector == 'industrial'],
                             lv_components, 'TestGrid',
                             aggregate_loads='sectoral')
        ...
        append_lv_components('StorageUnit', storages,
                             lv_components, 'TestGrid',
