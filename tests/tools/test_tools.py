...
class TestTools:
    ...
    def test_assign_feeder(self):
        ...
        assert (
            not topo.lines_df[~topo.lines_df.index.isin(mv_lines)]
            .lv_feeder.isna()
            .any()
        )
        ...
        assert (
            not topo.buses_df[~topo.buses_df.index.isin(mv_buses)]
            .lv_feeder.isna()
            .any()
        )
        ...
        # check specific buses
        assert (
            topo.buses_df.at["Bus_BranchTee_LVGrid_1_8", "lv_feeder"]
            == "Bus_BranchTee_LVGrid_1_7"
        )
        assert (
            topo.buses_df.at["Bus_BranchTee_LVGrid_2_4", "lv_feeder"]
