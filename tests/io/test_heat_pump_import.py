...
class TestHeatPumpImport:
    ...
    def test_oedb(self, caplog, db_engine):
        with caplog.at_level(logging.DEBUG):
            heat_pump_import.oedb(self.edisgo, scenario="eGon2035", engine=db_engine)
    ...
    def test_efficiency_resistive_heaters_oedb(self, db_engine):
        eta_dict = heat_pump_import.efficiency_resistive_heaters_oedb(
            scenario="eGon2035", engine=db_engine
        )
