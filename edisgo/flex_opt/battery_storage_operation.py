...
def apply_reference_operation(
    ...
    if edisgo_obj.topology.storage_units_df.efficiency_store.isna().all():
        logger.warning(
        ...
        edisgo_obj.topology.storage_units_df["efficiency_store"] = 0.95

    if edisgo_obj.topology.storage_units_df.efficiency_dispatch.isna().all():
        logger.warning(
        ...
        edisgo_obj.topology.storage_units_df["efficiency_dispatch"] = 0.95
