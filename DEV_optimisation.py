        ...
        for iteration in range(start_iter, int(len(
            ...
            try:
                model = update_model(model, timesteps, parameters, optimize_storage=optimize_storage,
                                     ...
                                     charging_start_ev=charging_start, energy_level_start_ev=energy_level_start,
                                     energy_level_end_ev=energy_level_end, **kwargs)
            except NameError:
                model = setup_model(parameters, timesteps, objective=objective,
                                    ...
                                    energy_level_start_ev=energy_level_start, energy_level_end_ev=energy_level_end,
